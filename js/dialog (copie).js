...
var EklaMapDialog = {
	...
	insert : function() {
		...
		{   //insertion du div et des coordonées qui seront convertis en
                    ...
                    strHtml = '<div class="Eklagooglemaps" id="Eklagooglemaps" style="background:#d3d3d3; border: 1px solid #000; width: 450px; height: 370px;">'+coords+'</div><br /><span style="font-size: x-small;"><em>Nom de la carte: </em></span>';
